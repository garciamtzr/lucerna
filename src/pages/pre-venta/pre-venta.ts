...
/**
 * Generated class for the PreVentaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-pre-venta',
  templateUrl: 'pre-venta.html',
})
...
//variables para Claves
 ...
 //version final
  ...
  openModal(){ //manda abrir el fragmento de productos
      ...
      const myModal: Modal = this.modal.create('PreVentaModalPage',{cliente: this.cliente, tipoRuta:this.tipRuta, reconoClie:this.reconocimientoCte}, myModalOptions);
...
//funcion para buscar y mostrar el valor del reconocimiento (arreglo)
  ...
  goTicket(){
    ...
    this.navCtrl.push("PreVentaTicketPage",{
...
openModalPromos(){ //manda abrir el fragmento de productos
  ...
  const myModal: Modal = this.modal.create('PrePromoModalPage',{cliente: this.cliente, tipoRuta:this.tipRuta, reconoClie:this.reconocimientoCte}, myModalOptions);
